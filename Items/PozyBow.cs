...
namespace ArknightsWeapons.Items
{
    public class PozyBow : ModItem
    {
        ...
        SoundStyle PozyAttack = new SoundStyle("ArknightsWeapons/Sounds/PozyAttack") with
        {
            Volume = 0.5f,
            PitchVariance = 0.3f,
            MaxInstances = 0,
		...
		*/
        ...
        public override void ModifyShootStats(Player player, ref Vector2 position, ref Vector2 velocity, ref int type, ref int damage, ref float knockback) {
            ...
            if (type == ProjectileID.WoodenArrowFriendly) { // or ProjectileID.WoodenArrowFriendly
                type = ModContent.ProjectileType<ArknightsWeapons.Projectiles.PenNib>(); // or ProjectileID.FireArrow;
