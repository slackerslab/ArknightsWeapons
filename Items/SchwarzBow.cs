...
namespace ArknightsWeapons.Items
{
    public class SchwarzBow : ModItem
    {
        ...
        SoundStyle SchwarzAttackSound = new SoundStyle("ArknightsWeapons/Sounds/SchwarzAttackSound") with
        {
            Volume = 0.5f,
            PitchVariance = 0.3f,
            MaxInstances = 0,
        ...
        SoundStyle SchwarzSkillSound = new SoundStyle("ArknightsWeapons/Sounds/SchwarzSkillSound") with
        {
            Volume = 0.5f,
            PitchVariance = 0.3f,
            MaxInstances = 0,
		...
		*/
        ...
        public override void ModifyShootStats(Player player, ref Vector2 position, ref Vector2 velocity, ref int type, ref int damage, ref float knockback) {
            ...
            { // or ProjectileID.WoodenArrowFriendly
                type = ModContent.ProjectileType<ArknightsWeapons.Projectiles.ArmorPiercingArrowhead>(); // or ProjectileID.FireArrow;
